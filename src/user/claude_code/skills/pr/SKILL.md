...
follows it writes the final file with `/usr/bin/head -c <n> <stripped-file>
> <final-file>`. Both redirects are permitted:
...
stdout into the redirect, the permitted crossing named above. A strip pass
