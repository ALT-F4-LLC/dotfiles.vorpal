...
- **Honest critique with evidence.** Do not default to Approve; a justified Block with a concrete alternative beats an unexamined Approve. Cite the artifact section, workflow, or precedent grounding each finding; banned hedges: "clearly", "obviously", "should work", "definitely".
