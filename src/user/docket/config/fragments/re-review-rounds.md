...
Everything else about the fix — it is unpinned by a new test (unless that gap
itself meets the ladder's Blocker rung), it is narrower or less elegant than
the ideal remedy, it would ideally also have handled an adjacent case, its
shape invites future defects — is authored at Concern or below. "The ideal fix
