...
3. Verifies the five CANONICAL blocks in THIS SKILL.md are byte-identical to the evolve-agents/evolve-skills siblings where shared (BANNER, EVOLUTION-MODEL, DOCS-PATHS-LOCAL structure, DISAMBIGUATION-CHARTER; SOURCE-OF-TRUTH is config-only). The HARVEST block is NOT a SKILL.md-local block in any of the three — it lives only in evolve-phase0-templates.md §2, sourced by reference at Phase-0 spawn time; flags any drift in the five local blocks.
...
3. Verify the five CANONICAL blocks in THIS SKILL.md (BANNER, EVOLUTION-MODEL, DOCS-PATHS-LOCAL, SOURCE-OF-TRUTH, DISAMBIGUATION-CHARTER) are byte-identical to the evolve-agents/evolve-skills siblings where shared (BANNER, EVOLUTION-MODEL, and DISAMBIGUATION-CHARTER are family-wide shared; DOCS-PATHS-LOCAL shares structure with config-specific paths; SOURCE-OF-TRUTH is config-only). The HARVEST block is NOT a SKILL.md-local block in any of the three siblings — it lives only in evolve-phase0-templates.md §2, sourced by reference at Phase-0 spawn time. Flag any drift in the five local blocks.
