...
name: evolve-skills
description: >
  Review and improve skill definitions via parallel @staff-engineer agents. Evaluates 9
...
**evolve-skills delta:** the reviewer reads `.claude/skills/*/SKILL.md` and `src/user/claude-code/skills/*/SKILL.md`; a CANONICAL-block or shared-frontmatter finding is applied family-wide in lockstep with byte-identity verification.
