    ...
    pub async fn build(self, context: &mut ConfigContext) -> Result<String> {
        ...
        let claude_code_config =
            ClaudeCode::new(claude_code_config_name.as_str(), self.systems.clone())
                ...
                .with_permission_allow("Bash(gh issue *)")
                .with_permission_allow("Bash(gh pr *)")
                ...
                .with_permission_allow("Bash(go get *)")
                ...
                .with_permission_allow("Bash(kubectl describe *)")
                .with_permission_allow("Bash(kubectl get *)")
                .with_permission_allow("Bash(kubectl logs *)")
