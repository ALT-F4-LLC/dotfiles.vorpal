...
- `sonnet` — Direct/Small/Medium implementation (`impl-{ID}`), `planner`.
- `opus` — general `reviewer-2`, `verifier*`, `tdd-author*`, Large/architecture and long-horizon multi-phase implementation.
