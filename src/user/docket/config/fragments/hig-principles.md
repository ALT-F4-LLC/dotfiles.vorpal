...
"Design principles" page (taglines verbatim). Cite them **by name**: "violates
Familiarity: the same concept is named two ways across surfaces" is checkable; "bad
usability" is not. A finding that names no principle is still reported: the principle
grounds a finding, it never gates raising one.
