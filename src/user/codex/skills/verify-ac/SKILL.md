...
**Triage first.** The calling agent (`@sdet`) selects depth — LIGHT or FULL — per the judgment described in `~/.codex/agents/sdet.toml`. This skill enforces the format once depth is chosen.
