...
`~/.claude/skills/team-doctrine/references/deep-collaboration.md` — repo:
`src/user/claude-code/skills/team-doctrine/references/deep-collaboration.md`. Read on demand
