...
**Copy states facts in plain words.** Marketing verbs (empower, streamline, supercharge,
elevate, transform) and importance claims never appear in interface copy; say what the
control does. No em dashes in copy strings: labels, messages, and one-line summaries are
short copy, and short copy re-punctuates with a period, comma, or colon instead.
