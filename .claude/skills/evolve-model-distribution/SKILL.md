...
```bash
grep -n 'Tiers (four named tiers' src/user/claude-code/agents/team-lead.md      # locate the block
grep -nE '^- .(bronze|silver|gold|diamond). ' src/user/claude-code/agents/team-lead.md  # the canonical-tier bullets
