...
|---|---|---|---|
| Agentic prose layer | `agents/claude-code/*.md` (7 files, 2276 lines) and `skills/claude-code/**/SKILL.md` (13 project skills, 3239 lines) — the role definitions and skill contracts that drive this team | Highest churn in the repo by a wide margin: `agents/claude-code/team-lead.md` 50 commits, `sdet.md` 49, `staff-engineer.md` 48, `senior-engineer.md` 48 in the last 100 commits | Cross-file incoherence — a rule changed in one agent file that contradicts a canonical block mirrored in another, or a skill contract that drifts from the agent that invokes it |
...
flowchart TD
    ...
    Triage -->|Agentic prose| Prose[agents/claude-code/*.md, skills/claude-code/**/SKILL.md]
