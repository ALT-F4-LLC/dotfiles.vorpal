    ...
    pub async fn build(self, context: &mut ConfigContext) -> Result<String> {
        ...
        let claude_code_config =
            ClaudeCode::new(claude_code_config_name.as_str(), self.systems.clone())
                ...
                .with_permission_allow("Read(~/.claude/projects/**)")
                .with_permission_allow("Read(~/.claude/tasks/**)")
                .with_permission_allow("Read(~/.claude/teams/**)")
                ...
                .with_permission_allow("Write(~/.claude/projects/**)")
                .with_permission_allow("Write(~/.claude/tasks/**)")
                .with_permission_allow("Write(~/.claude/teams/**)")
                ...
                .with_permission_deny("Edit(~/.claude/**)")
                ...
                .with_permission_deny("Read(~/.claude/**)")
                ...
                .with_permission_deny("Write(~/.claude/**)")
